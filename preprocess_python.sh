...
TRAIN_DIR=python/train
VAL_DIR=python/val
TEST_DIR=python/test
DATASET_NAME=data_python
MAX_CONTEXTS=200
...
java -jar ${EXTRACTOR_JAR} code2vec --lang py --project python/val --output python/result/val
...
java -jar ${EXTRACTOR_JAR} code2vec --lang py --project python/test --output python/result/test
...
java -jar ${EXTRACTOR_JAR} code2vec --lang py --project python/train --output python/result/train
