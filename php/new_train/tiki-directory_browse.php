<?php
// $Header: /cvsroot/tikiwiki/tiki/tiki-directory_browse.php,v 1.2.4.3 2004/03/28 09:59:50 damosoft Exp $
...
if($categ_info['allowSites']=='y') {
  ...
  if($items["cant"] > ($offset+$directory_links_per_page)) {  $smarty->assign('next_offset',$offset + $directory_links_per_page);} else {  $smarty->assign('next_offset',-1); }
  if($offset>0) {  $smarty->assign('prev_offset',$offset - $directory_links_per_page);  } else {  $smarty->assign('prev_offset',-1); }
