...
EXTRACTOR_JAR=php/cli-0.3.jar #JavaExtractor/JPredict/target/JavaExtractor-0.0.1-SNAPSHOT.jar
...
java -jar ${EXTRACTOR_JAR} code2vec --lang php --project php/val --output php/result/val
...
java -jar ${EXTRACTOR_JAR} code2vec --lang php --project php/test --output php/result/test
...
java -jar ${EXTRACTOR_JAR} code2vec --lang php --project php/val --output php/result/train
