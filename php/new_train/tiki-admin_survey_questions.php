<?php
// $Header: /cvsroot/tikiwiki/tiki/tiki-admin_survey_questions.php,v 1.4.6.3 2004/03/30 19:56:10 damosoft Exp $
...
if(isset($_REQUEST["save"])) {
  ...
  $srvlib->replace_survey_question($_REQUEST["questionId"], $_REQUEST["question"], $_REQUEST["type"], $_REQUEST["surveyId"],$_REQUEST["position"],$_REQUEST["options"]);
  $info["question"]='';
  $info["type"]='';
  $info["position"]='';
  $info["options"]='';
